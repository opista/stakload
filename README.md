...
- Frontend
  ...
  - Sometimes database queries are slow. We should update useGamesQuery to return a loading state, and then update the UI to show it (maybe a skeleton loader?)
