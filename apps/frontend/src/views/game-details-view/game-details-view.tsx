...
import { GameLinks } from "@components/game/game-links";
import { IncompatibilityIcon } from "@components/icons/incompatibility-icon";
import { LibraryIcon } from "@components/icons/library-icon";
import { ProtonIcon } from "@components/icons/proton-icon";
import { GameHeader } from "@components/layout/desktop/game-header";
